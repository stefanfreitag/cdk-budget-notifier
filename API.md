...
| <code><a href="#aws_budget_notifier.BudgetNotifier.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="aws_budget_notifier.BudgetNotifier.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="aws_budget_notifier.BudgetNotifier.with.parameter.mixins"></a>
